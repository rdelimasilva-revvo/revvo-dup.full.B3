...
const routeLabelMap: Record<string, string> = {
  ...
  'agente-intermediador/monitoramento': 'Monitoramento',
  'agente-intermediador/visao-negociacoes': 'Visão de Negociações',
  'automacoes': 'Automações',
  'automacoes/manifestacao': 'Manifestação',
  'automacoes/escrituracao': 'Escrituração',
